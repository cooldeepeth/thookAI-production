...
### Missing Responsive Breakpoints (14)
Pages without `md:` / `lg:` Tailwind breakpoints for tablet/mobile:
...
|----------|-------|----------------|-------|
| HIGH | Responsive breakpoints | 14 | Phase 14-17 |
| MEDIUM | Empty states | 10 | Phase 14-17 |
| LOW | data-testid coverage | 12 | Phase 20 |
